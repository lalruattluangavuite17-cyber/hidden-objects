...
/* =====================================================
   ROOM 04 OBJECT HINTS
===================================================== */

const hints = {

    "dart-board":
        "Something made for a game is waiting somewhere in the café.",

    "eight-point-star":
        "Look carefully for a star with more points than usual.",

    "rotary-phone":
        "A device from another era is waiting for someone to call.",

    "queen-of-hearts":
        "A royal card is hiding somewhere among the café's little details.",

    "fish-cross":
        "Two shapes meet to form a curious symbol.",

    "ceramic-mug":
        "A simple cup is waiting somewhere a late-night drink might have been served.",

    "cocktail-glass":
        "Something made for a special drink is waiting under the midnight lights.",

    "curious-cat":
        "A quiet four-legged guest is watching the café from somewhere nearby.",

    "bottle-ship":
        "A tiny voyage has been trapped inside something much smaller than the sea.",

    "club-sandwich":
        "A stacked café favourite is hiding somewhere around the tables.",

    "no-smoking":
        "A familiar symbol tells visitors what they cannot do inside.",

    "exit-sign":
        "When the night is over, this sign points the way out."
...
function gameOver() {
    ...
    hintText.textContent =
        "The café is still hiding things...";
