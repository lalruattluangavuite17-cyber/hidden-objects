/* =====================================================
   HIDDEN OBJECTS
   ROOM 05 — THE ABANDONED TAILOR SHOP
===================================================== */
...
/* =====================================================
   ROOM 05 OBJECT HINTS
===================================================== */

const hints = {

    "lady-of-pain":
        "A mysterious lady waits quietly among the forgotten things.",

    "iron-bell":
        "Something made of iron once called customers into this shop.",

    "celestial-moon":
        "Look for a small moon that seems to belong to the night sky.",

    "ballerina-figure":
        "A tiny dancer has been left frozen in an elegant pose.",

    "ruby-diamond":
        "Something red and precious is hiding among the old belongings.",

    "leather-wallet":
        "An old personal belonging may still be waiting where its owner left it.",

    "m-rag":
        "A piece of cloth marked with a mysterious letter is hiding nearby.",

    "horse-statue":
        "A silent horse stands somewhere inside the forgotten shop.",

    "king-piece":
        "A small royal figure is waiting to be discovered.",

    "forgotten-scarf":
        "Something warm and forgotten has been left behind in the shop.",

    "bowl-fish":
        "Look for a little swimmer inside a large open bowl.",

    "old-picture":
        "An old memory hangs somewhere among the abandoned belongings."
...
function gameOver() {
    ...
    hintText.textContent =
        "The tailor shop is still hiding things...";
